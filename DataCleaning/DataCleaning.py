...
def datacleaning():
  ...
  '''
  print("Iniciando proceso de Datacleaning...")
  path = os.getcwd()
  path = path.replace("\\", "\\\\")
  path = path.replace("\\\\", "/") + "/"
  path_data = path + "Data/"
  ...
  print("Shape dataframe de covid:")
  ...
  print("Shape dataframe de clima-iso:")
