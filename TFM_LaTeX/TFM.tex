...
Del grafico anterior observamos que los intervalos de confianza (en el cual se encuentra, con alta probabilidad, el valor real de una determinada variable) en su gran mayoría o casi todos son intervalos amplios, es decir los valores están dispersos. Los diagnósticos de los residuos fueron los siguientes:
\newpage
\begin{figure}[H]
	\begin{center}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.6\textwidth]{real_vs_pred_RL}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.8\textwidth]{real_vs_pred_random_forest}
